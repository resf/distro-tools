                    ...
                    if href.rstrip("/").lower() == "repodata":
                        ...
                        try:
                            ...
                            if repomd_response.status_code == 200:
                                ...
                                print(
                                    f"Found repomd.xml: {repomd_url}", file=sys.stderr
                                )
                        ...
                        if (
                            subdir_url != url
                            and subdir_url not in visited_urls
                            and subdir_url.startswith(base_url)
                        ):
    ...
    if crawl:
        ...
        for arch, repos in arch_repos.items():
            ...
            if name_suffix is not None and name_suffix != "":
                mirror_name = f"Rocky Linux {detected_version} {name_suffix} {arch}"
            else:
                mirror_name = f"Rocky Linux {detected_version} {arch}"
            ...
            mirror_config = {
                ...
                "mirror": {
                    ...
                    "match_major_version": int(detected_version.split(".")[0])
